...
const config = {
  ...
  useEffect(() => {
    // Check if userCart is an array before using reduce
    if (Array.isArray(userCart)) {
      ...
      // Handle the case where userCart is not an array (log, set total to 0, etc.)
      console.error('userCart is not an array:', userCart);
      setUpdatedItemTotal(0);
    }
        ...
        <div className="container-xxl">
          <div className="row">
            <div className="col-12">
              ...
              {Array.isArray(userCart) && userCart.map((item) => (
