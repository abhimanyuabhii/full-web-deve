...
useEffect(()=>{
if(authState.ordered!==null && authState.orderedProduct?.success ===true){
  navigate("/Orders")
}
},[authState])
  ...
  const checkOutHandler = async () => {
    try {
      ...
      console.log(shippingInfo)
           dispatch(createAnOrder({totalPrice:total,orderItems:cartProductState,paymentInfo:result.data,shippingInfo:JSON.parse(localStorage.getItem("address"))}))
            ...
            <div className="col-7">
              <div className="checkout-left-data">
                ...
                <form  onSubmit={formik.handleSubmit}
                 action=""  className="d-flex gap-15 flex-wrap justify-content-between custom-input">
                  <div className="w-100">
                  <select
  name="country"
  ...
  <option value="Bihar">Bihar</option>
                  ...
                  <div className="w-100">
                    <div className="d-flex justify-content-between align-items-center">
                      ...
                      <button className="button custom-button" type='submit' disabled={formik.isSubmitting}>Place Order</button>
                    </div>
                  </div>
                  </div>
                  </div>
