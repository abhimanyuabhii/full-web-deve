          ...
          <div className="row">
            ...
            <div className="col-12 col-md-3 mb-4 mb-md-0">
              ...
              <div className="footer-links d-flex flex-column">
                ...
                <Link className="text-white py-2 mb-1">Visit Our Store</Link>
              </div>
            </div>
            ...
            <div className="col-12 col-md-2">
              ...
              <div className="footer-links d-flex flex-column">
                <Link className="text-white py-2 mb-1">Diamond</Link>
                <Link className="text-white py-2 mb-1">Naclace</Link>
                <Link className="text-white py-2 mb-1">Pendants</Link>
